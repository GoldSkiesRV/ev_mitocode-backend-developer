...
public class StudentController {
    ...
    @GetMapping("/orderstudents")
    public ResponseEntity<List<StudentDTO>> OrderBy(@RequestParam(name = "param", defaultValue = "DESC") String param){
        List<StudentDTO> list = service.OrderByAge(param).stream().map(this::convertToDTO).toList();
        return new ResponseEntity<>(list, HttpStatus.OK);
    }
